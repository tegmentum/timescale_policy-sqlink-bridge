...
const PROVIDER_ID: &str = "timescale_policy-composed";
...
fn scalar_name_by_id(id: u64) -> Option<&'static str> {
    match id {
        1 => Some("add_columnstore_policy"),
        2 => Some("add_compaction_policy"),
        3 => Some("add_compression_policy"),
        4 => Some("add_job"),
        5 => Some("add_policies"),
        6 => Some("add_reorder_policy"),
        7 => Some("add_retention_policy"),
        8 => Some("alter_job_set_hypertable_id"),
        9 => Some("alter_policies"),
        10 => Some("delete_job"),
        11 => Some("remove_all_policies"),
        12 => Some("remove_columnstore_policy"),
        13 => Some("remove_compaction_policy"),
        14 => Some("remove_compression_policy"),
        15 => Some("remove_policies"),
        16 => Some("remove_reorder_policy"),
        17 => Some("remove_retention_policy"),
        18 => Some("reorder_chunk"),
        19 => Some("restart_background_workers"),
        20 => Some("run_job"),
        21 => Some("start_background_workers"),
        22 => Some("stop_background_workers"),
        _ => None,
    }
}
...
impl MetadataGuest for Component {
    fn describe() -> Manifest {
        let scalar_functions: Vec<ScalarFunctionSpec> = vec![
            ScalarFunctionSpec {
                id: 1,
                name: "add_columnstore_policy".to_string(),
                num_args: -1,
                func_flags: FunctionFlags::DETERMINISTIC,
            },
            ScalarFunctionSpec {
                id: 2,
                name: "add_compaction_policy".to_string(),
                num_args: -1,
                func_flags: FunctionFlags::DETERMINISTIC,
            },
            ScalarFunctionSpec {
                id: 3,
                name: "add_compression_policy".to_string(),
                num_args: -1,
                func_flags: FunctionFlags::DETERMINISTIC,
            },
            ScalarFunctionSpec {
            ...
            ScalarFunctionSpec {
                id: 5,
                name: "add_policies".to_string(),
                num_args: -1,
                func_flags: FunctionFlags::DETERMINISTIC,
            },
            ScalarFunctionSpec {
                id: 6,
                name: "add_reorder_policy".to_string(),
                num_args: -1,
                func_flags: FunctionFlags::DETERMINISTIC,
            },
            ScalarFunctionSpec {
                id: 7,
                name: "add_retention_policy".to_string(),
                num_args: -1,
                func_flags: FunctionFlags::DETERMINISTIC,
            },
            ScalarFunctionSpec {
                id: 8,
                name: "alter_job_set_hypertable_id".to_string(),
                num_args: -1,
                func_flags: FunctionFlags::DETERMINISTIC,
            },
            ScalarFunctionSpec {
                id: 9,
                name: "alter_policies".to_string(),
                num_args: -1,
                func_flags: FunctionFlags::DETERMINISTIC,
            },
            ScalarFunctionSpec {
            ...
            ScalarFunctionSpec {
                id: 11,
                name: "remove_all_policies".to_string(),
                num_args: -1,
                func_flags: FunctionFlags::DETERMINISTIC,
            },
            ScalarFunctionSpec {
                id: 12,
                name: "remove_columnstore_policy".to_string(),
                num_args: -1,
                func_flags: FunctionFlags::DETERMINISTIC,
            },
            ScalarFunctionSpec {
                id: 13,
                name: "remove_compaction_policy".to_string(),
                num_args: -1,
                func_flags: FunctionFlags::DETERMINISTIC,
            },
            ScalarFunctionSpec {
                id: 14,
                name: "remove_compression_policy".to_string(),
                num_args: -1,
                func_flags: FunctionFlags::DETERMINISTIC,
            },
            ScalarFunctionSpec {
                id: 15,
                name: "remove_policies".to_string(),
                num_args: -1,
                func_flags: FunctionFlags::DETERMINISTIC,
            },
            ScalarFunctionSpec {
                id: 16,
                name: "remove_reorder_policy".to_string(),
                num_args: -1,
                func_flags: FunctionFlags::DETERMINISTIC,
            },
            ScalarFunctionSpec {
                id: 17,
                name: "remove_retention_policy".to_string(),
                num_args: -1,
                func_flags: FunctionFlags::DETERMINISTIC,
            },
            ScalarFunctionSpec {
                id: 18,
                name: "reorder_chunk".to_string(),
                num_args: -1,
                func_flags: FunctionFlags::DETERMINISTIC,
            },
            ScalarFunctionSpec {
                id: 19,
                name: "restart_background_workers".to_string(),
                num_args: -1,
                func_flags: FunctionFlags::DETERMINISTIC,
            },
            ScalarFunctionSpec {
            ...
            ScalarFunctionSpec {
                id: 21,
                name: "start_background_workers".to_string(),
                num_args: -1,
                func_flags: FunctionFlags::DETERMINISTIC,
            },
            ScalarFunctionSpec {
                id: 22,
                name: "stop_background_workers".to_string(),
                num_args: -1,
                func_flags: FunctionFlags::DETERMINISTIC,
            },
        ];
...
fn vtab_name_by_id(id: u64) -> Option<&'static str> {
    match id {
        2000000 => Some("alter_job"),
        2000001 => Some("show_policies"),
        _ => None,
    }
}
...
impl VtabGuest for Component {
    ...
    fn connect(
        ...
        match vtab_id {
                2000000 => Ok("CREATE TABLE x(\"result\" BLOB, \"_arg0\" HIDDEN, \"_arg1\" HIDDEN, \"_arg2\" HIDDEN, \"_arg3\" HIDDEN, \"_arg4\" HIDDEN, \"_arg5\" HIDDEN, \"_arg6\" HIDDEN, \"_arg7\" HIDDEN, \"_arg8\" HIDDEN, \"_arg9\" HIDDEN, \"_arg10\" HIDDEN, \"_arg11\" HIDDEN, \"_arg12\" HIDDEN, \"_arg13\" HIDDEN, \"_arg14\" HIDDEN)".to_string()),
